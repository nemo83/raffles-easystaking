  ...
  return (
    <Layout>
      ...
      <div
        ...
        style={{
          height: 400 + "px",
          backgroundImage: `url(${easy1staking.src})`,
        }}
      >
        <div
        ...
        <section className="my-8 text-center bg-white rounded-lg">
          <div className="px-6 py-12 md:px-12">
            <h2 className="p-6 my-12 space-y-3 text-5xl font-bold tracking-tight text-gray-800 uppercase bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-white">
              Hello Delegate! <br />
              <span className="text-3xl normal-case text-myblue">
                Have you checked our perks yet?
              </span>
            </h2>
            <a
        ...
        <section className="my-8 text-center bg-white rounded-lg">
          <div className="px-6 py-12 md:px-12">
            <h2 className="p-6 my-12 space-y-3 text-5xl font-bold tracking-tight text-gray-800 uppercase bg-gray-100 rounded-lg dark:bg-gray-800 dark:text-white">
              ...
              <span className="text-3xl normal-case text-myblue">
                Delegate to EASY1 and enjoy extra rewards
              </span>
            </h2>
            <button
              className=" inline-block py-3 mb-2 text-sm font-medium leading-snug text-white uppercase transition duration-150 ease-in-out rounded shadow-md bg-myblue px-7 hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg md:mr-2"
            ...
            <a
              className="inline-block py-3 mb-2 text-sm font-medium leading-snug uppercase transition duration-150 ease-in-out bg-transparent rounded text-myblue px-7 hover:text-blue-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none focus:ring-0 active:bg-gray-200"
              href="#offerings"
              role="button"
            >
              Learn more
      ...
      <section className="my-8 bg-white rounded-lg" id="offerings">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-3xl font-bold text-center text-black capitalize lg:text-3xl">
            Explore our{" "}
            <span className="font-bold text-mypink">Incentives</span>{" "}
   
          </h1>
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            {offerings.map((offering, i) => (
              <div key={i} className="flex justify-center ">
                <div className="flex flex-col max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 gap-3">
                  <a className="flex items-center" href="#">
                  <span className="inline-block p-3 text-mypink bg-mypink-100 rounded-full dark:text-white dark:bg-blue-500 mr-2">
                      <FontAwesomeIcon
                        icon={offering.icon}
                  ...
                  {offering.linkValue ? (
                    <a
                      href={offering.linkValue}
                      className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-mypink rounded-lg hover:bg-pink-400 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit mt-auto"
                    >
                      {offering.linkText}
                      <svg
      ...
      <h2 className="text-3xl font-bold text-center text-black capitalize lg:text-3xl mb-2">
            Distributions
      </h2>
      <EstimateRewards />
      <Distributions />
