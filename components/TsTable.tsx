...
export const TsTable = ({entries, title, closed, base_address } : TsTableData) => {
        ...
        if (resp?.status == 200) {
            ...
            if(body.already_submitted) {
                ...
                try {
                    ...
                    toast.error("There was an error processing the transaction.\nTry again in a few minutes")
                }
                ...
                <div className="relative w-auto max-w-3xl mx-auto my-6">
                    <div className="relative flex flex-col w-full bg-white border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                        <div className="flex items-start justify-between p-5 text-black border-b border-gray-300 border-solid rounded-t">
                            <h3 className="text-3xl font-semibold capitalize">Congratulations!</h3>
                            <button
                                    ...
                                    <div className="mb-3 xl:w-96">
                                        ...
                                        <a className='text-blue-500'
                                         href={`https://cardanoscan.io/transaction/${txHash}`}>
                                           { txHash? `${txHash.slice(0, 6)}...${txHash.slice(txHash.length - 3)}` : null } 
                                        </a>
                                            </p>
                        ...
                        <div className="flex items-center justify-end p-6 border-t border-solid rounded-b border-blueGray-200">
                            ...
                            href={`https://twitter.com/intent/tweet?text=${encodeURI(raffleWonTweet)}&hashtags=Cardano,Staking,EASY1,NFT`}
                            target="_blank"
